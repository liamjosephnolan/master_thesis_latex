...
\begin{enumerate}
    \setcounter{enumi}{7} % Continue numbering from the previous list
...
Let $x, y, z$ be the Cartesian coordinates of the target position. The joint angles are defined as:
...
\begin{figure}[H] % Placement specifiers: h=here, t=top, b=bottom, p=page of floats
    ...
    \end{lstlisting}
    \caption{This is an optional caption for the figure itself.} % Optional figure caption
...
\textbf{State Calculation, LQR, and Feedforward}
